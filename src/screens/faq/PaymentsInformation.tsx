...
type PaymentsInformationScreenProps = NativeStackScreenProps<
  RootStackParamList,
  "PaymentsInformationScreen"
>;

const PaymentsInformationScreen = ({
  navigation,
}: PaymentsInformationScreenProps) => {
  const { t } = useTranslation();

  return (
    <View flex={1} bg={"BACKGROUND_COLOR"} px={horizontalScale(20)}>
      <AppBar name={t("payments")} onPress={navigation.goBack} />
